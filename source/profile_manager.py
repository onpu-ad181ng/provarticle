...
class ProfileManager:
  def __init__(self, dao: DAO, profiles_layout, article_manager: ArticleManager,
               preferences_manager: PreferencesManager, profile_name_text, profile_desc_text,
  ...
  def draw_profiles(self):
    ...
    for i, drawn_profile in enumerate(profiles):
  ...
  def _switch_profiles(self, profile_id):
    ...
    self._preferences_manager.visualize_topics()


  def _delete_profile(self):
    delete_name = self._profile_name_text.text()
    pass
